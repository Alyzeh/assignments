...
<body>
	...
	<main>
		...
		<form method="post" action="names.php">
			<button type="submit" class="btn btn-primary" id="addName" name="addName">Add Name</button> <button type="reset" class="btn btn-primary" id="clearNames" name="clearNames">Clear Names</button>
			<div class="mb-3">
